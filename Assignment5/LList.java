    ...
    */
     ...
     */
    	...
    	public void reverse() {
        	...
        	//REPLACING FIRST ELEMENT WITH THE LAST AND SECOND WITH SECOND LAST AND SO ON....
        	for(int i=1;i<=(this.getLength()/2);i++) {
        		
        		//SWAPPING VALUES USING REPLACE FUNCTION..
        		T temp=getEntry(i);
        		this.replace(i,this.getEntry(this.getLength()+1-i));
        		this.replace((this.getLength()+1-i),temp);
     ...
     */
    	public void cycle() {
        	...
        	//GET THE FIRST ELEMENT OF LIST
             ...
             //SHIFT THE LIST TO LEFT BY REPLACING EACH ELEMENT WITH ELEMENT SUCCEEDING IT
            
             for(int i=1;i<this.getLength();i++) {
           	  this.replace(i,this.getEntry(i+1));
             }
             
             //REPLACE THE LAST ELEMENT WITH TEMP(FIRST)
             this.replace(this.getLength(), temp);         
